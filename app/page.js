...
const six_text = `Many crucial aspects that were essential to what we aimed to achieve went awry, and now all that remains is for us to scrutinize the mistakes we made.`
    ...
    <div className="w-screen flex bg-white justify-center">
      <div className="flex flex-col items-center text-black mt-28 md:mt-20">
        ...
        <div className="flex flex-col space-y-2 mt-4">
          ...
          <p className=" text-xs font-light tracking-wider max-w-2xl px-5">{six_text}</p>
